...
class Calculator():
    def __init__(self, master):
        ...
        self.equation.set("0")
        self.entry_value = ""
        Entry(width= 17,bg="#6C6F7F", font=("Arial Bold", 28), textvariable=self.equation).place(x=0, y=0)
        ...
        Button(width=11, height=4, text="=", relief="flat", bg="#5C6672", command=lambda:self.solve()).place(x=270, y=350)
        Button(width=11, height=4, text="C", relief="flat", bg="#5C6672", command=lambda:self.clear()).place(x=0, y=350)
